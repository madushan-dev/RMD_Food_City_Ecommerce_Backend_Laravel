                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <form action="{{ route('categories')}}/{{ $category->id }}" method="POST" class="m-0">
                                                                @csrf
                                                                @method('DELETE')
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">            
                                              ...
                                              <form action="{{ route('categories')}}/new" method="POST">
                                                @csrf
                                       
                                            <div class="general-label">
                                                <div class="row">
                                                    <div class="form-group mb-1 col-6">
                                                        <h4 class="header-title mt-0 pb-2">Category Name</h4>
